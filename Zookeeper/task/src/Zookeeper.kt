...
fun main() {
   ...
   while (scanner.hasNext()) {
      ...
      if (input != "exit") {
         if (input == "0") { println(animals[0]) }
         if (input == "1") { println(animals[1]) }
         if (input == "2") { println(animals[2]) }
         if (input == "3") { println(animals[3]) }
         if (input == "4") { println(animals[4]) }
         if (input == "5") { println(animals[5]) }
         else { println("Please enter a number from 0 to 5 or exit if you want to close the program") }
      } else if (input == "exit") {
